...
// Require models
require('./app/server/routes/login.js')(app);

// Database models
require('./app/server/models/organizers.js')(mongoose);
require('./app/server/models/assigment.js')(mongoose);
require('./app/server/models/confirmed_sponsor.js')(mongoose);
require('./app/server/models/sponsers.js')(mongoose);
require('./app/server/models/sponsor_checklist.js')(mongoose);
